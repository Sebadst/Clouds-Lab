...
// TODO: add the pair objects as TextPair fields
    ...
    public int hashCode() {
        // TODO: implement hash
        String couple = this.key1.toString() + this.key2.toString();
    ...
    public boolean equals(Object o) {
        ...
        TextPair c = (TextPair) o;
        return (c.getFirst().equals(this.key1) && c.getSecond().equals(this.key2));
    }

    @Override
    public int compareTo(TextPair tp) {
        // TODO: implement the comparison between this and tp
        int diff = this.getFirst().compareTo(tp.getFirst());
        if(diff == 0)
            diff = this.key2.compareTo(tp.getSecond());
